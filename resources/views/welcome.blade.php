...
<head>
    ...
    <style>
        ...
        *, ::before, ::after {
        ...
        /* Style the "powered by" section */
        h5.font-weight-light a {
        ...
        /* Add margin to the GitHub link */
        .nav-item {
            margin-left: 15px;
        }

        /* Center align the header text on medium and larger screens */
        @media (min-width: 768px) {
            h1.font-serif {
                text-align: center;
            }
    ...
    <div class="row mt-3 ">
        <div class="col-md">
            <header>
                <div class="row">
                    <div class="col-md">
                        <h1 class="title text-md-center font-serif">
                            Instantly Search <br class="d-md-none">
                            10,000 Users with Laravel Scout + Typesense Driver
                        </h1>
                        <h5 class="text-md-center mt-3 font-weight-light">
                            <div class="d-md-inline d-block mt-3">
                                ...
                                <a href="https://typesense.org" target="_blank">
                                    <img src="https://typesense.org/docs/images/typesense_logo.svg" width="120" alt="Typesense" class="mx-2"
